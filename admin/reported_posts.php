<?php
	...
	else
	{
		...
		{ 
			...
			echo '<a href="?pid=0&amp;page=reported_posts" alt="第一页"><<</a> <a class="news" href="?pid='.$back_page.'&amp;page=reported_posts" alt="上一页"><</a>';
		}
		...
		{ 
			...
			echo '<a href="?pid='.$next_page.'&amp;page=reported_posts" alt="下一页">></a> <a  href="?pid='.$lastpage.'&amp;page=reported_posts" alt="最后一页">>></a></font></center>';
		}
	}
?>
</div></div></body></html>