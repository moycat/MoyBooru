<?php
	...
	$page_limit = 4;
	print '<div class="content"><table class="highlightable" style="width: 100%; font-size: 12px;"><tr><th>帖子ID:</th><th>Reason:</th><th>分数:</th><th>Date Posted:</th><th>Unflag:</th></tr>';
