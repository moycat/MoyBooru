<?php
 ...
 <source src="f6ca1c7d5d00a2a3fb4ea2f7edfa0f96a6d09c11717f39facabad2d724f16fbb/videos/'.$post_data['image'].'" type=\'video/mp4\'>
		...
		else
		{
			...
			if($post_data['width'] > 900)
				echo '<a href="'.$imgurl.'" target="_blank"><b>→图片过大，已自动缩放。点击查看原图</b></a><br />';
			echo '<img alt="img" src="'.$imgurl.'" id="image" onclick="Note.toggle();" style="margin-right: 70px; max-width: 900px;" />';
		}
